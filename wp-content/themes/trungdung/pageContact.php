             ...
             <div class="row">
            	<div class="col-md-5">
            		<div class="contact_left">
            			...
            			<iframe width="460" height="360" frameborder="0" scrolling="no" marginheight="0" src="https://maps.google.com/maps?q=46 Trần Quốc Hoàn, Hà Nội, Cầu Giấy, Việt Nam, &t=&z=14&ie=UTF8&iwloc=&output=embed" marginwidth="0"><a class="addmaps" href="http://www.map-embed.com/it/"id="get-map-data" mce_href="http://maps.google.com/maps/api/js?sensor=false">map-embed.com</a><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></iframe> </a></small>
						<address class="address">
							<p>Cơ sở 1: 46 Trần Quốc Hoàn - Cầu Giấy - Hà Nội <br>Cơ sở 2: 16 Phạm Tuấn Tài - Cầu Giấy - Hà Nội</p>
							<dl>
								<dt></dt>
								<div>Điện thoại:<span> 0968. 35. 36. 88</span></div>
								<div>Hotline:<span> 0986. 345. 188</span></div>
								
								<div>Email:&nbsp; <a href="trungdungrestaurant@yahoo.com">trungdungrestaurant@yahoo.com</a></div>
								<div>facebook:&nbsp; <a href="https://www.facebook.com/trungdungrestaurant?fref=ts">https://www.facebook.com/trungdungrestaurant?fref=ts</a></div>
							</dl>
						</address>
            		</div>
            	</div>
            	<div class="col-md-7 contact_right">
            		...
            		<div class="contact-form">
							<form method="post" action="">
								...
								<input required type="text" name ="mail" class="textbox"  placeholder="Email">
				...
				<br>
				<div class="col-md-12"<hr style="background-color:#996633; color:#996633"></div>
				<br>
				<div>
