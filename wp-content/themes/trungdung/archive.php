   ...
   <div class="container">
     <div class="row">
		...
		if(have_posts()):
			...
			<h1 class="post_title archive_title">Archive for the &#8216;<?php single_cat_title(); ?>&#8217; Category</h1><?php
		
			} elseif( is_tag() ) { // If this is a tag archive
			
			?>
			
			<h1 class="post_title archive_title">Posts Tagged &#8216;<?php single_tag_title(); ?>&#8217;</h1><?php
			...
			<h1 class="post_title archive_title">Archive for <?php the_time('Y'); ?></h2>
			<?php
			...
			<form id="archive_search_form" method="get" action="<?php bloginfo('home'); ?>">
				<fieldset id="archive_search_fieldset">
					...
					<div class="archive_search_item">
						...
						<input type="submit" name="archive_search_submit" id="archive_search_submit" value="<?php esc_attr_e('Search'); ?>" />
					</div>
				</fieldset>
			</form>
