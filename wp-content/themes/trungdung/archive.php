                        ...
                        <div id="primary_content"><?php
                            ...
                            <h1 class="post_title archive_title">Archive for <?php the_time('Y'); ?></h2>
                                ...
                                while (have_posts()):
                                    ...
                                    <div <?php post_class() ?>>
                                        <h2 id="archive_item_<?php the_ID(); ?>" class="post_title archive_item_title">
                                            <a href="<?php the_permalink() ?>" rel="bookmark"
                                               class=" post_title_link archive_item_title_link"><?php the_title(); ?></a>
                                        </h2>
                                        <p class="post_meta archive_item_meta">Published in <?php the_category(', ') ?>
